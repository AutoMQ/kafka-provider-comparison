...
$SSH_BASE_CMD $SSH_HOST "sudo echo "$BOOTSTRAP_SERVER" >  $BENCHMARK_DIR/workflow_scripts/bin/bootstrap-server.txt"
$SSH_BASE_CMD $SSH_HOST "sudo echo hello >  $BENCHMARK_DIR/workflow_scripts/bin/test.log"
